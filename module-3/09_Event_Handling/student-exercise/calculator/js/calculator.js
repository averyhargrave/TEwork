...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // loop over each of the numbers and add a click event listener to each number to call the function clickNumber
  ...
  // loop over each of the operators and add a click event listener to each operator to call the function clickOperator
  theOperators.forEach((anOperator) => {
                                        anOperator.addEventListener('click', (event) => {
                                                                                         clickOperator(event);
                                                                                        });
                                       });

  // add click event listener for the equal sign that should call the function performOperation

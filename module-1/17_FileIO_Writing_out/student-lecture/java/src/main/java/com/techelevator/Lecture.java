...
public class Lecture {
	...
	public static void main(String[] args) throws IOException {
		...
		/* 
		 * TLDR: When you have a File object instantiated, you can do a lot of things with it
		 * 
		 ...
		 * 
		 * Does a file exist?
		 * How long is the file? (How many chars are in the file - 0 means empty)
		 * Create new empty files
		 * Create new directories
		 * Remove/Delete files
		 * Remove/Delete directories
		 * 
		 * Many of the things you can do from command line, you can do in a program with a File object
		 */
		...
		File newFile = new File(newDirectory, fileName); // Define a File object for the directory and file we want to create
														 // If you omit the directory, we assume the default directory
		...
		try(PrintWriter writer = new PrintWriter(newFile)) { // Putting the PrintWriter instantiation in a try means we don't need to close it
			writer.println(message); // Use the same methods as you did with System.out.println, .print, or .printf

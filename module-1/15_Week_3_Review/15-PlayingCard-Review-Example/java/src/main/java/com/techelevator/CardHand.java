 ...
 ***************************************************************************************************/
// This class is abstract meaning it is only intended to be a superclass for inheritance
//      you cannot instantiate a CardHand by itself, only its subclasses
// Provide a generic definition for a CardHand -- all CardHands have similar characteristics
//                                                the game using a CardHand identifies additional characteristics
public abstract class CardHand   implements ValidCardHand  { 
	...
	// protected - any subclass has access to the member data
	// we want to allow any subclass of CardHand to access aHand directly without using methods
...
@Override     // Ask compiler to check to be sure this is a valid override of superclass or interface method
	public abstract void dealHand(CardDeck aDeck); // we don't know how to deal a hand, that's up to the game - abstract
                                                   // we have to define dealHand because the interface we implement requires it

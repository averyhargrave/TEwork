...
public class IntroToClassesCard {
	...
	//
	// main() is always static because there can only be one for an application
	//*****************************************************************************
	...
	public static void main(String[] args) {
        ...
        */
		...
		// .equals defaults to the .equals of the Objects class
		// Does a PlayingCard equal another PlayingCard with the same values
		if(card4.equals(card5)) { // cannot use == to see if reference variables are equal, as it checks location instead of contents
			                      //                use .equals() to compare content of reference variables (instead of location)

...
public class ItalianPlayingCard extends PlayingCard {
	...
	public ItalianPlayingCard() 
	{
		...
		initializeMaps(); // initializeMaps will run when the constructor is run even if the maps are already initialized
	} 

	public ItalianPlayingCard(int value, String suit) {
		super(value, suit, suitMap.get(suit));{ //potentional error - this will fail if the maps are not initialized

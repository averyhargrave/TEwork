...
public class UsePlayingCards {
	...
	public static void main(String[] args) {
		...
		aSwissCard3.value = 11; // okay since value is protected instead of private
		
	System.out.println("\n----- Polymorphism example follows ------ \n");
		
									//new CollectionType<what-it-holds>
		List<PlayingCard> someCards = new ArrayList<PlayingCard>(); // by using the superclass as the type, we can put subclass objects in it

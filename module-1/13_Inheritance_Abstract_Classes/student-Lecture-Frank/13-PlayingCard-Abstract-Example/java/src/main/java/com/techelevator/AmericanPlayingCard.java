...
public class AmericanPlayingCard extends PlayingCard{
	...
	// by making the method that calls intializeMaps static and anonymous,
	...
	// a subclass may override a superclass method if it wants to change behavior of the superclass method
	
	@Override // asks the compiler to check that the method that follows is a valid override
			  // an overriding method must have the same name and parameters, same type and order

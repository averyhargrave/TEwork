...
public class PlayingCard {
	 ...
	 ***************************************************************************************/
// making the parameters the same name as the data members requires 'this.' to be coded when referencing data members
	public PlayingCard(int value, String suit, String color) {
		this.value = value; // this. is required to indicate the
		this.suit  = suit;  // current object because the parameters **************************************************** <-- explanation of 'this.'
		this.color = color; // have the same names as data members
	}

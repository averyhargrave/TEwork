 ...
 ******************************************************************************************/
	...
	private void handleChangeEmployeeDepartment() {
		...
		employeeDAO.changeEmployeeDepartment(selectedEmployee.getEmployeeId(), selectedDepartment.getId());  // If your getters are not called "getId()", change this to what yours is called
	}
	...
	private void handleEmployeeProjectRemoval() {
		...
		if(projectEmployees.size() > 0) {
			...
			projectDAO.removeEmployeeFromProject(selectedProject.getId(), selectedEmployee.getEmployeeId()); // If your getters are not called "getId()", change this to what yours is called
	...
	private void handleEmployeeProjectAssignment() {
		...
		projectDAO.addEmployeeToProject(selectedProject.getId(), selectedEmployee.getEmployeeId());  // If your getters are not called "getId()", change this to what yours is called

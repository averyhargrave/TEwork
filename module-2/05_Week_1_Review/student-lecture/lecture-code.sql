...
-- in order to add a language we need to know the country, isOfficial, and percentage because they are all required
-- we can't just add 'Elvish' as a language without e
...
--    'ZZZ' does not exist as a key in the country table, therefore this fails
--     Be sure any foreign key you specify has a primary key in the parent table

-- begin transaction;
--
-- insert into countrylanguage                     
-- (countrycode, language, isofficial, percentage) 
-- values('ZZZ', 'English', true, 16);   
-- 
-- rollback;

-- 3. Try deleting the country USA. What happens?
-- country code 'USA' is used as a foreign key in another table 
...
-- violates unique contrait because 'USA' is already an existing key
-- begin transaction;

-- insert into countrylanguage
-- (countrycode, language, isofficial, percentage)
-- values('USA', 'English', true, 36);

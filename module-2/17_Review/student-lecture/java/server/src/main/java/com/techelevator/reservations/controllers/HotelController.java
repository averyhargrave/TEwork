...
public class HotelController {
    ...
    // Use @PreAuthorize Spring Expression Language annotation to define which role(s) which have access
    // hasRole() tells Spring to check that the user sending the request has the role indicated
    // hasAnyRole('ADMIN', 'CREATOR', 'JASON')") - allows any of the listed roles access to the method
    @PreAuthorize("hasRole('ADMIN')") // single quotes around ADMIN because hasRole goes inside double quotes
